...
public class GithubService {
    ...
    private final Type MAP_TYPE_TOKEN = new TypeToken<Map<String, String>>() {
    }.getType();
    ...
    public static class RepositoryQuery {
        ...
        public RepositoryQuery(String owner, String repositoryName) {
            this.owner = owner;
    ...
    public String getRepositoryInfoJson(RepositoryQuery repositoryQuery) throws RepositoryNotFoundException, ServiceUnavailableException {
        //mock response from the API
        RepositoryInfo repositoryInfo = gson.fromJson(EXAMPLE_RESPONSE, RepositoryInfo.class);
        if ("not_existing_user".equals(repositoryQuery.getRepositoryName())) {
            throw new RepositoryNotFoundException();
        } else if ("gradle-gatling-plugin".equals(repositoryQuery.getRepositoryName())) {
            throw new ServiceUnavailableException();
        }
        return gson.toJson(repositoryInfo, RepositoryInfo.class);
    }
